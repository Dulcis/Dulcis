    ...
    if(isset($_SESSION['user_id'])) {
        ...
        if(isset($_POST['fase1']) || isset($_POST['fase2']) || isset($_POST['fase3']) || isset($_POST['fase4']) || isset($_POST['fase5'])) {
            ...
            if(isset($_POST['fase1'])) {
                ...
                echo'<p><label for="user_term" accesskey="e">有効期限：</label><br>' . $user_term . '<input type="hidden" name="user_term" value="' . $user_term . '" /></p>';
                ...
                echo '<p><label for="user_mailadd" accesskey="m">メールアドレス：</label><br><input type="text" name="user_mailadd" value="' . $user_mailadd . '" maxlength="40" class="validate[required,custom[email],ajax[ajaxMailUpdateCallPHP] text-input" /></p>';
                ...
                echo'<p><label for="user_term" accesskey="e">有効期限：</label><br><input type="text" name="user_term" value="' . $user_term . '" required /></p>';
                ...
                echo'<p><label for="user_tel" accesskey="t">電話番号：</label><br>' . $user_tel . '<input type="hidden" name="user_tel" value="' . $user_tel . '" /></p>';
                echo'<p><label for="user_card" accesskey="c">クレジットカード番号：</label><br>' . $user_card . '<input type="hidden" name="user_card" value="' . $user_card . '" /></p>';
                echo'<p><label for="user_term" accesskey="e">有効期限：</label><br>' . $user_term . '<input type="hidden" name="user_term" value="' . $user_term . '" required /></p>';
