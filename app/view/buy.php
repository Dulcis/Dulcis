        ...
        if(isset($_POST['query'])) {
            ...
            if(mysqli_num_rows($result) == 0) {
                ...
                if(isset($_POST['check'])) {
                    ...
                    //会員情報
                    echo '<h3>商品の送り先</h3>';
                    echo '<h4>名前</h4><input type="text" name="user_name" value="' . $user_name . '" maxlength="20" class="validate[required]" />';
					//echo '<input type="hidden" name="user_mail" id = "user_mail" value="' . $user_mailadd . '">';
					echo '<br>';
